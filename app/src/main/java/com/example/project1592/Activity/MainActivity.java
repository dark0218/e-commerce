...
import com.example.project1592.Domain.CategoryDomain;
import com.example.project1592.Domain.ItemsDomain;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initLocation() {
        String[] items = new String[]{"Dehradun, india", "delhi, India"};
